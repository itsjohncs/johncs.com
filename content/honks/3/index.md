...
Ever struggle to figure out why that pesky element isn't shrinking despite setting `flex-shrink`? I learned today that the default minimum size of a Flex item is usually `min-content`, [though there's more details of course](https://www.w3.org/TR/css-flexbox-1/#min-size-auto).
