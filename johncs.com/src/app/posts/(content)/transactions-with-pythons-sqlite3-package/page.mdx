...
export const metadata = {
  ...
  description: (
    <>
      Python's <Code>sqlite3</Code> package tries to take care of the tricky
      business of properly executing <Code>BEGIN</Code> and <Code>COMMIT</Code>{" "}
      statements. The rules of when and how this automatic transactioning is
      done has confounded a number of developers, many of whom have jumped ship
      and chosen to use the{" "}
      <a href="https://github.com/rogerbinns/apsw">aspw</a> package or similar.
    </>
  ),
};
